  ...
  "maxYear": año máximo o null
        ...
        cars = cars.filter((car) => {
            if (criteria.make && !car.make?.toLowerCase().includes(criteria.make.toLowerCase()))
                return false;
            if (criteria.bodyType && !car.bodyType?.toLowerCase().includes(criteria.bodyType.toLowerCase()))
                return false;
            if (criteria.fuel && !car.fuel?.toLowerCase().includes(criteria.fuel.toLowerCase()))
                return false;
            if (criteria.transmission && !car.transmission?.toLowerCase().includes(criteria.transmission.toLowerCase()))
                return false;
